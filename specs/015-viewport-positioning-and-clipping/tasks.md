# Tasks: 015 viewport positioning and clipping

- [x] T1 Research axicli clipping → research.md
- [x] T2 ArtworkTransform model + tests
- [x] T3 Liang–Barsky + segment/path tests (partial vs spec §25 matrix)
- [x] T4 plot_viewport pipeline (svgelements, flatten, emit SVG, validator)
- [x] T5 positioned_plot_service + empty intersection guard
